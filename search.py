    ...
    def actions(self, x):
        ...
        if x.children != [] and x.leaf not in specials:
            if (x.leaf == '+') and x.children[0].leaf == '^' and x.children[1].leaf == '^' and \
                ...
                counter+=1
                acts = dict(list(acts.items()) + list(self.actions(x.children[0]).items()) + list(self.actions(x.children[1]).items()))
                return acts
            if  x.leaf == '=' and x.children[0].leaf == "sqrt" and x.children[0].children.leaf == self.variable :
                ...
                counter+=1
                acts = dict(list(acts.items()) + list(self.actions(x.children[1]).items()))
                return acts
